...
from carbonaware_scheduler._utils import asyncify, parse_datetime
...
class TestCarbonawareScheduler:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    def test_copy(self, client: CarbonawareScheduler) -> None:
        copied = client.copy()
        assert id(copied) != id(client)

    def test_copy_default_options(self, client: CarbonawareScheduler) -> None:
    ...
    def test_copy_signature(self, client: CarbonawareScheduler) -> None:
    ...
    def test_copy_build_request(self, client: CarbonawareScheduler) -> None:
    ...
    def test_request_timeout(self, client: CarbonawareScheduler) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_default_headers_option(self) -> None:
        test_client = CarbonawareScheduler(
            base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        ...
        test_client2 = CarbonawareScheduler(
            base_url=base_url,
    ...
    def test_hardcoded_query_params_in_url(self, client: CarbonawareScheduler) -> None:
    ...
    def test_request_extra_json(self, client: CarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: CarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: CarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, client: CarbonawareScheduler
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = CarbonawareScheduler(base_url=base_url, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = CarbonawareScheduler(base_url=base_url, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: CarbonawareScheduler
    ) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
        respx_mock.post("/v0/schedule/").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.schedule.with_streaming_response.create(
                duration="PT1H",
                windows=[
                    {
    ...
    @mock.patch("carbonaware_scheduler._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: CarbonawareScheduler) -> None:
...
class TestAsyncCarbonawareScheduler:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncCarbonawareScheduler) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    async def test_raw_response_for_binary(
        self, respx_mock: MockRouter, async_client: AsyncCarbonawareScheduler
    ) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncCarbonawareScheduler) -> None:
        copied = async_client.copy()
        assert id(copied) != id(async_client)

    def test_copy_default_options(self, async_client: AsyncCarbonawareScheduler) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncCarbonawareScheduler) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncCarbonawareScheduler) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncCarbonawareScheduler) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        test_client = AsyncCarbonawareScheduler(
            base_url=base_url, _strict_response_validation=True, default_headers={"X-Foo": "bar"}
        )
        request = test_client._build_request(FinalRequestOptions(method="get", url="/foo"))
        assert request.headers.get("x-foo") == "bar"
        ...
        test_client2 = AsyncCarbonawareScheduler(
            base_url=base_url,
            _strict_response_validation=True,
            default_headers={
                "X-Foo": "stainless",
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncCarbonawareScheduler) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncCarbonawareScheduler) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncCarbonawareScheduler) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_trailing_slash(self, client: AsyncCarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncCarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncCarbonawareScheduler) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncCarbonawareScheduler(base_url=base_url, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = AsyncCarbonawareScheduler(base_url=base_url, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncCarbonawareScheduler
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.schedule.with_streaming_response.create(
                duration="PT1H",
                windows=[
                    {
                        "end": parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncCarbonawareScheduler) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
