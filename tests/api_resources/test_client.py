...
class TestClient:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve(self, client: Carbonaware) -> None:
        client_ = client.retrieve()
        assert_matches_type(RetrieveResponse, client_, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve(self, client: Carbonaware) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve(self, client: Carbonaware) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve(self, async_client: AsyncCarbonaware) -> None:
        client = await async_client.retrieve()
        assert_matches_type(RetrieveResponse, client, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve(self, async_client: AsyncCarbonaware) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve(self, async_client: AsyncCarbonaware) -> None:
