...
from carbonaware_scheduler import CarbonawareScheduler, DefaultAioHttpClient, AsyncCarbonawareScheduler
from carbonaware_scheduler._utils import is_dict
...
def client(request: FixtureRequest) -> Iterator[CarbonawareScheduler]:
    ...
    with CarbonawareScheduler(base_url=base_url, _strict_response_validation=strict) as client:
        yield client
